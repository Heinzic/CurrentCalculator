...
import { IConsumer } from "../../models/IConsumers";
    ...
    return (
        <>
            <div className="table-row text-center rounded-md align-middle h-[40px] group">
                ...
                <div className="border-r-black border-r px-[5px] table-cell align-middle bg-[#EBEBEB]">{Number(consumer.volume)} {consumer.type_unit_measurement}</div>
                ...
                <div className=" px-[5px] table-cell align-middle bg-[#EBEBEB] rounded-r-md">
                    <div className="flex justify-between">
                        ...
                        <button type="button" className="invisible group-hover:visible" onClick={() => handleDelete(consumer.id? consumer.id: 0)}>
